...
public class MediatypeService {
	...
	public static final MediaType TXT = new MediaType("text/plain", ".txt");	
	...
	public static final MediaType XML = new MediaType("text/xml", ".xml");
	...
	public static MediaType[] mediatypes = new MediaType[] {
		XHTML, EPUB, JPG, PNG, GIF, CSS, SVG, TTF, NCX, XPGT, OPENTYPE, WOFF, SMIL, PLS, JAVASCRIPT, MP3, MP4, XML, PDF, TXT
	};
