...
//					|| (keyEvent.getKeyCode() == KeyEvent.VK_DOWN)) {
	...
	public void displayPage(Resource resource, int sectionPos) {
		...
		try {
			...
			Logger.getLogger(ContentPane.class.getName()).log(Level.SEVERE, "When reading resource " + resource.getId() + "("
	...
	public void hyperlinkUpdate(HyperlinkEvent event) {
		...
		if (resource == null) {
			Logger.getLogger(ContentPane.class.getName()).log(Level.WARNING, "Resource with url " + resourceHref + " not found");
		} else {
