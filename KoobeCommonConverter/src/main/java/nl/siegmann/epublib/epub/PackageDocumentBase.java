...
public class PackageDocumentBase {
	...
	protected interface OPFValues {
		...
		// epub3 (http://www.idpf.org/epub/30/spec/epub30-publications.html#sec-item-property-values)
		String cover_image = "cover-image";
		String mathml = "mathml";
		String nav = "nav";
		String remove_resources = "remote-resources";
		String scripted = "scripted";
		String svg = "svg";
		String epub_switch = "switch";
	}
}