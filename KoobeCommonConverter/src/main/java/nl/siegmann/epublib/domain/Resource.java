...
public class Resource implements Serializable {
	...
	protected String inputEncoding = Constants.ENCODING;
	protected byte[] data;
	...
	public Resource(byte[] data, String href) {
		this(null, data, href, MediatypeService.determineMediaType(href), Constants.ENCODING, ZipEntry.DEFLATED);
	}
	 ...
	 * @param data The Resource's contents
	 * @param href The location of the resource within the epub. Example: "chapter1.html".
	 * @param compressMethod The method of compression is used for this resource. Example, ZipEntry.STORED means not to compress this resource.
	 */
	public Resource(byte[] data, String href, int compressMethod) {
		this(null, data, href, MediatypeService.determineMediaType(href), Constants.ENCODING, compressMethod);
	}
	...
	public Resource(Reader in, String href) throws IOException {
		this(null, IOUtil.toByteArray(in, Constants.ENCODING), href, MediatypeService.determineMediaType(href), Constants.ENCODING, ZipEntry.DEFLATED);
	}
	...
	public Resource(String id, byte[] data, String href, MediaType mediaType) {
		this(id, data, href, mediaType, Constants.ENCODING, ZipEntry.DEFLATED);
	}
	 ...
	 * @param compressMethod The method of compression is used for this resource. Example, ZipEntry.STORED means not to compress this resource.
	 */
	public Resource(String id, byte[] data, String href, MediaType mediaType, String inputEncoding, int compressMethod) {
		this.id = id;
		this.href = href;
	...
	public byte[] getData() throws IOException {
		...
		if ( data == null ) {
			...
			Logger.getLogger(Resource.class.getName()).log(Level.INFO, "Initializing lazy resource " + fileName + "#" + this.href );
	...
	/**
	 * @param compressMethod the compressMethod to set
	 */
	...
	/**
	 * (ePub3 only) This resource's properties.
	 * 
	 * @return
	 */
	...
	public void setProperties(String i_propertiess) {
		this.properties = i_propertiess;
	}
}
